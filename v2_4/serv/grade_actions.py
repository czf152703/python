...
async def action_grade_add(request):
    ...
    stu_sns = params.get("stu_sn")
    cou_sn = params.get("cou_sn")
    grade = params.get("grade")

    if stu_sns is None or cou_sn is None or grade is None:
        return web.HTTPBadRequest(text="stu_sns, cou_sn, grade must be required")
    ...
    try:
        with db_block() as db:
            ...
            """, dict(stu_sns=stu_sns, cou_sn=cou_sn, grade=grade))
